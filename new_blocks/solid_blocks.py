...
class SolidBlock(Block):
    ...
    def go_down_diagonal(self, neighbours) -> bool:
        ways = [0, 2]
        shuffle(ways)
    ...
    def go_down(self, neighbours) -> bool:
